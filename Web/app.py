...
def security_rules():
    ...
    try:
        ...
        cursor.execute("SELECT id, rule, description FROM SecurityRules")
...
def add_rule():
    ...
    try:
        ...
        cursor.execute("INSERT INTO SecurityRules (rule, description) VALUES (%s, %s)", (rule_name, description))
        conn.commit()
...
def edit_rule(rule_id):
    ...
    cursor.execute("SELECT id, rule, description FROM SecurityRules WHERE id = %s", (rule_id,))
...
def update_rule(rule_id):
    ...
    cursor.execute("UPDATE SecurityRules SET rule = %s, description = %s WHERE id = %s", (rule_name, description, rule_id))
    conn.commit()
